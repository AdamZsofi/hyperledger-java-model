...
import hu.bme.mit.ftsrg.scil.model.FabricNetworkBuilder;
import hu.bme.mit.ftsrg.scil.model.Network;
import hu.bme.mit.ftsrg.scil.model.participants.application.TrainClient;
import hu.bme.mit.ftsrg.scil.model.participants.ordering.FaultMode;
...
public class Main {
  ...
  public static FaultMode ordererFaultMode = FaultMode.canLose;
