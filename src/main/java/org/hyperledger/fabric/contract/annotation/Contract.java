 ...
 *
 * <p>Analogous to the {@link org.hyperledger.fabric.contract.annotation.Contract} annotation.
 *
...
public @interface Contract {
  ...
  String name() default "";
  String transactionSerializer() default "hu.bme.mit.ftsrg.scil.mockfabric.contract.execution.JSONSerializer";
}
